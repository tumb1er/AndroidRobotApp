package ru.tumbler.androidrobot.connection;
...
public class NetworkDiscovery {
    ...
    public void startServer(int port) {
        try {
            wifiLock();
            mServiceInfo = ServiceInfo.create(RobotService.SERVICE_TYPE, RobotService.SERVICE_NAME, port, RobotService.SERVICE_NAME);
    ...
    public String getServerInfo(){
        return String.valueOf(mServiceInfo);

    }

    public void findServers(final OnFoundListener listener) {
        mJmDNS.addServiceListener(RobotService.SERVICE_TYPE, mServiceListener = new ServiceListener() {
            @Override
    ...
    public void reset() {
        if (mJmDNS != null) {
            if (mServiceListener != null) {
                mJmDNS.removeServiceListener(RobotService.SERVICE_TYPE, mServiceListener);
    ...
    private void wifiLock() {
        ...
        mMulticastLock = wifiManager.createMulticastLock(RobotService.SERVICE_NAME);
